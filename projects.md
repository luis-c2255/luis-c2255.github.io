...
<div class="content-section fade-in">
  ...
  <div class="projects-stats">
    <div class="project-stat-item">
      <span class="stat-icon"><iconify-icon icon="fxemoji:briefcase" width="48"></iconify-icon></span>
      <span class="stat-value">{{ site.projects.size }}</span>
      <span class="stat-label">Total Projects</span>
    </div>
    <div class="project-stat-item">
      <span class="stat-icon"><iconify-icon icon="fluent-emoji-flat:laptop" width="48"></iconify-icon></span>
      <span class="stat-value">10+</span>
      <span class="stat-label">Technologies Used</span>
    </div>
    <div class="project-stat-item">
      <span class="stat-icon"><iconify-icon icon="noto:globe-showing-asia-australia" width="48"></iconify-icon></span>
